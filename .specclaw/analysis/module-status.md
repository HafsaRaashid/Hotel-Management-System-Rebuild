# Module Status: Hotel-Management-System-Rebuild
...
| Module | Name | Depends on | Backlog items (planned/total) | Scenarios (captured/designed) | Latest replay verdict | Stub-tainted items | Partially built items | Quality remediation | Open questions |
|---|---|---|---|---|---|---|---|---|---|
| MOD-001 | Authentication & Access Control | MOD-002 | 3/3 | 10/10 | no module-scoped run | 0 | 0 | — | 0 |
| MOD-002 | User Account Management | MOD-001 | 3/3 | 5/5 | no module-scoped run | 0 | 0 | — | 0 |
| MOD-003 | Room & Rate Management | none | 4/4 | 1/1 | no module-scoped run | 0 | 0 | — | 0 |
| MOD-004 | Booking & Stay Lifecycle | MOD-003 | 10/10 | 21/21 | no module-scoped run | 0 | 0 | ⚠ BLOCKED | 0 |
| MOD-005 | Customer Management | none | 3/3 | 6/6 | no module-scoped run | 0 | 0 | — | 0 |
| MOD-006 | Public Marketing Site | none | 1/1 | 0/0 | no module-scoped run | 0 | 0 | — | 0 |
| MOD-007 | Dashboard & Reporting | MOD-002, MOD-003, MOD-004, MOD-005 | 1/1 | 0/0 | no module-scoped run | 0 | 0 | — | 0 |
...
_None — no active dependency bypass stubs. Every module is being built on the real modules it depends on._
